...
parser = optparse.OptionParser(cyan+"""
...
Usage : python3 findAdmin.py [OPTIONS]  [URL]
                       ________________________________________________________________________________
                      |          .:: OPTIONS ::.            	       .:: Description ::.               |
                      +===================================+============================================+
                      |  -u  , --url                      |  input url to find admin c-panel 	         |
                      |===================================+============================================|
                      |                            .:: EXAMPLES ::.                                    |
                      |           python3 findAdmin.py -u https://www.google.com/                      |
                      |           [*] Note : (  /  ) is very important                                 |   
                      |           python3 findAdmin.py --url https://www.google.com/                   |
                      ==================================================================================
""")

parser.add_option("-u","--url",dest="url",type="string",help="input url to find admin c-panel")
...
"""+yl+"""                                                                                        
        ...
        list_admin = ['admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','usuarios/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
""") 
        ...
        sys.exit()
    except urllib.request.error.URLError as msg:
        print (url)
        print (msg)
else:
    print(parser.usage)
